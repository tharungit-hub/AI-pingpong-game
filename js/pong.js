...
// Creating the Model for the Game for good detection 
const modelParams = {
...
// This for Toggle button triggers the button 
trackButton.addEventListener("click", function () {
    toggleVideo();
});


// This function for running detections after time intervel   
...
// Bead Details Number of balls should fall 
var NUM_BEADS = 6
...
planck.testbed(function (testbed) {
    ...
    var globalTime = 0;
    var CHARACTER_LIFETIME = 6000 // how much time should balls there Live
    ...
    // Remove paddles that are no longer in frame. this is not in use
...
//Updates the score if we Toch Balls
...
//Playing Audio
    ...
    //This the main box of Updating Score and animation
...
//This our Paddle or Bed main Player
    function addPaddle() {
    ...
    // Generate Beads falling from sky
    function generateBeads(numCharacters) {
        ...
        for (var i = 0; i < numCharacters; ++i) {
            ...
            var shape = pl.Circle(SPACE_WIDTH * beadWidthFactor +1);
